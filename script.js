...
window.onload = function init() {
		...
		_program.program = initShaders(gl, "vertex-shader", "fragment-shader");
...
function setCanvasSize(canvas) {
		canvas.width = window.innerWidth - document.getElementById("partnum").offsetWidth - 55;
...
function initTextures(){	
		var img1 = document.getElementById("texImage0");
